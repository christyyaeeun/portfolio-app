...
import {
    Box, Flex, IconButton, Button, Stack, useColorMode, useColorModeValue,
...
export const Navbar = () => {
    ...
    const handleViewResume = () => {
        window.open(
            'https://firebasestorage.googleapis.com/v0/b/christypark-portfolio.appspot.com/o/portfolio%20files%2Fproject%20files%2FPortfolio-Resume.pdf?alt=media&token=1ad1ce8d-6802-4015-9602-e7a0d674a318',
            '_blank'
        );
    };
            ...
            <Box w="100vw" position="fixed" top="0" zIndex="999">
                ...
                >
                    ...
                    <Flex flex={ { base: 1 } } justify={ { base: 'center', md: 'start' } }>
                        ...
                        <Flex
                            ...
                            />
                            <Button className="color-toggle" variant="ghost" onClick={ toggleColorMode }>
                        ...
                        <Flex className="nav-link" fontSize="large" fontWeight="700" display={ { base: 'none', md: 'flex' } } ml={ 10 }>
                            <NavLink className='link link-styles' to="/" onClick={ closeDrawer }>
                                Home
                            </NavLink>
                            <NavLink className='link link-styles' to="/about" onClick={ closeDrawer }>
                                About
                            </NavLink>
                            <NavLink className='link link-styles' to="/portfolio" onClick={ closeDrawer }>
                                Portfolio
                            </NavLink>
                            <NavLink className='link link-styles' to="/contact" onClick={ closeDrawer }>
                                Contact
                            </NavLink>
                        </Flex>
                    </Flex>
                    ...
                    {/* View Resume Button */ }
                    <Button display={ { base: 'none', lg: 'block' } } colorScheme="blue" variant={ colorMode === 'light' ? 'outline' : 'solid' } onClick={ handleViewResume }>
                        View Resume
                    </Button>

                    {/* Color Mode Toggle Button */ }
                    <Button className="color-toggle" color={ colorMode === 'light' ? '#363737' : 'white' } variant="ghost" display={ { base: 'none', md: 'flex', lg: 'flex' } } onClick={ toggleColorMode }>
                        { colorMode === 'light' ? <MoonIcon /> : <SunIcon /> }
                    </Button>
                </Flex>
                {/* Drawer Content */ }
                ...
                <div
                    style={ {
                        ...
                        width: '70%',
                        height: '100%',
                        background: colorMode === 'light' ? 'white' : '#2c313d',
                        zIndex: 999,
