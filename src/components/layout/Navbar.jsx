                ...
                >
                    ...
                    <Flex flex={ { base: 1 } } justify={ { base: 'center', md: 'start' } }>
                        ...
                        <Flex className="nav-link" fontSize="large" fontWeight="700" display={ { base: 'none', md: 'flex' } } ml={ 10 }>
                            <NavLink className='link' to="/" onClick={ closeDrawer }>
                                Home
                            </NavLink>
                            <NavLink className='link' to="/about" onClick={ closeDrawer }>
                                About
                            </NavLink>
                            <NavLink className='link' to="/portfolio" onClick={ closeDrawer }>
                                Portfolio
                            </NavLink>
                            <NavLink className='link' to="/contact" onClick={ closeDrawer }>
                                Contact
                            </NavLink>
                        </Flex>
                    </Flex>
